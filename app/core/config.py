...
class Settings(BaseSettings):
    ...
    db_user: str = Field(default="roadbogo", validation_alias="DB_USER")
    db_password: str = Field(default="change-me", validation_alias="DB_PASSWORD")
    db_scheme: str = Field(default="roadbogo", validation_alias="DB_SCHEME")
